...
Revision ID: 5806d179dac3
Revises: 9756a442e912
Create Date: 2025-02-21 13:58:07.404113
...
revision: str = '5806d179dac3'
down_revision: Union[str, None] = '9756a442e912'
...
def upgrade() -> None:
    ...
    op.add_column('usertable', sa.Column('marital_status', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
