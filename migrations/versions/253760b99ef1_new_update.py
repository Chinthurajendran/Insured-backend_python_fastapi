...
Revision ID: 253760b99ef1
Revises: b0d8fba606f6
Create Date: 2025-02-27 10:35:12.184326
...
revision: str = '253760b99ef1'
down_revision: Union[str, None] = 'b0d8fba606f6'
...
def downgrade() -> None:
    ...
    sa.Column('policy_holder', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('policy_name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('policy_type', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('income_range', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('id_proof', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('passbook', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('photo', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('pan_card', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('income_proof', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('nominee_address_proof', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('feedback', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('policy_status', postgresql.ENUM('approved', 'processing', 'rejected', name='approvalstatus'), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['policy_id'], ['policytable.policy_uid'], name='policydetails_policy_id_fkey'),
