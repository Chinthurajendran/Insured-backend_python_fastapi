...
Revision ID: 4071be59dfcf
Revises: 34838a29c642
Create Date: 2025-02-07 23:11:47.975719
...
revision: str = '4071be59dfcf'
down_revision: Union[str, None] = '34838a29c642'
...
def downgrade() -> None:
    ...
    sa.Column('coverage', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('settlement', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('premium_amount', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('age_group', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('income_range', sa.INTEGER(), autoincrement=False, nullable=False),
